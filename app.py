...
aurora_db_name = 'dtqsweetdatabase' #os.environ['DB_NAME']
aurora_cluster_arn = 'arn:aws:rds:us-west-2:XXX:cluster:database-1' #os.environ['CLUSTER_ARN']
aurora_secret_arn = 'arn:aws:secretsmanager:us-west-2:XXX:secret:DTQAuroraServerlessDemoCredentials-YqOh81' #os.environ['SECRET_ARN']
